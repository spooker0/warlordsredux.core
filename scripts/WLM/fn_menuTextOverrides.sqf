...
private _overrideMagazineNames = createHashMapFromArray [
    ...
    ["60Rnd_CMFlareMagazine", "Countermeasures"],
    ["120Rnd_CMFlareMagazine", "Countermeasures"],
    ["240Rnd_CMFlareMagazine", "Countermeasures"],
    ["60Rnd_CMFlare_Chaff_Magazine", "Countermeasures"],
    ...
    ["300Rnd_CMFlare_Chaff_Magazine", "Countermeasures"],
    ...
    ["PylonRack_7Rnd_Rocket_04_HE_F", "Shrieker Runway Buster"],
    ["PylonRack_7Rnd_Rocket_04_AP_F", "Shrieker AP"],
    ["PylonRack_12Rnd_PGM_missiles", "DAGR-M"],
    ["PylonRack_20Rnd_Rocket_03_HE_F", "Tratnyr Runway Buster"],

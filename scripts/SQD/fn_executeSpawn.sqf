...
if (alive _spawnTarget) exitWith {
    [_spawnTarget, false, true] spawn WL2_fnc_executeFastTravelVehicle;
};
...
switch (_spawnType) do {
    ...
    case "stronghold": {
        ...
        if (_canTravelStronghold) then {
            [5, _target, true] spawn WL2_fnc_executeFastTravel;
        };
    };
    case "fob": {
        ...
        if (_canTravelFOB) then {
            ...
            [6, _forwardBaseArea, true] spawn WL2_fnc_executeFastTravel;
        };
    };
    case "home": {
    ...
    case "squadmate": {
        ...
        if (_canTravelSquadmate) then {
            [_target, false, true] spawn WL2_fnc_executeFastTravelVehicle;
        };
    };
    default {
        [false] call WL2_fnc_spawnAtBase;

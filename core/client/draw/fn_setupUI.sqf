...
if (_displayClass == "RequestMenu_open") then {
...

	{
		...
		localize "STR_WL_lightVehicles",
		localize "STR_WL_heavyVehicles",
		localize "STR_WL_rotaryWing",
		localize "STR_WL_fixedWing",
		localize "STR_WL_remoteControl",
		localize "STR_WL_airDefense",
		localize "STR_WL_sectorDefense",
